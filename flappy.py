...
def draw_floor():
    ...
    screen.blit(floor_surface,(floor_x_pos + 324,500))
...
def score_display(game_state):
    if game_state == 'main_game':
        ...
        score_rect = score_surface.get_rect(center = (155,50))
    ...
    if game_state == 'game_over':
        ...
        high_score_rect = high_score_surface.get_rect(center = (155,425))
...
game_over_rect = game_over_surface.get_rect(center = (160,256))
